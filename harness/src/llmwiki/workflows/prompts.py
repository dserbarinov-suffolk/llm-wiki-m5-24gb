...
QUERY_TEMPLATE = _BASE + (
    ...
    "shows the catalog of every page). For complex procedures, decision "
...
CHAT_TEMPLATE = _BASE + (
    ...
    "first message includes a bounded relevant catalog excerpt: use it to "
    "find likely pages. For complex procedures, decision trees, tables, or "
    "large pages, inspect_page first with focus_query set to the user's target "
    "topic or procedure, then read the smallest useful page chunks before "
    "answering substantively — catalog snippets alone are too thin for detailed "
    "claims. When a focused page map reports no matching section headings, "
