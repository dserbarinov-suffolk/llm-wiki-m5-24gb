...
CHAT_TEMPLATE = _BASE + (
    ...
    "find likely pages and read the smallest useful page chunks before answering "
    "substantively — catalog snippets alone are too thin for detailed claims. "
    "Do not crawl every nearby page; answer as soon as the current evidence "
    "supports the response. Use search_wiki with alternate terms when the "
    "excerpt is insufficient. Questions about the "
