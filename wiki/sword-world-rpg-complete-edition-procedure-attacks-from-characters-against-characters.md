...
- `rule`: [[sword-world-rpg-complete-edition-section-4-7-attacks-from-characters-against-characters-c8e7911d]]#atom-technical-atom-28c8ef4f85c0f8b4 Sometimes, especially when the mastermind behind an incident is a dark priest, you'll have to fight against someone whos _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-01325))_
- `formula`: [[sword-world-rpg-complete-edition-section-4-7-attacks-from-characters-against-characters-c8e7911d]]#atom-technical-atom-cd2408e63862aa38 attacker's final score = attack power + 2D _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-01329))_
