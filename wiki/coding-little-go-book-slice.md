...
projection_coverage: topic-coding-little-go-book-slice@79167120fa490d1c1b458f9c89f357ba
---
...
- [[coding-little-go-book-maps-array-and-slice]] - narrower topic: Maps, Arrays and Slices shares source evidence from Chapter 3 - Maps, Arrays and Slices / Slices: In Go, you rarely, if ever, use arrays directly. Instead, you use slices. A slice is a lightweight structure that wraps and represents a portion of an array. There a ... [truncated]; Maps, Arrays and Slices shares technical record from Chapter 3 - Maps, Arrays and Slices / Slices: scores := []int{1,4,293,4,9} (39 shared statement(s), 22 shared atom(s))
- [[coding-little-go-book-maps-array]] - shared statements and technical atoms: Maps Array shares source evidence from Chapter 3 - Maps, Arrays and Slices / Slices: In Go, you rarely, if ever, use arrays directly. Instead, you use slices. A slice is a lightweight structure that wraps and represents a portion of an array. There a ... [truncated]; Maps Array shares technical record from Chapter 3 - Maps, Arrays and Slices / Slices: scores := []int{1,4,293,4,9} (14 shared statement(s), 14 shared atom(s))
