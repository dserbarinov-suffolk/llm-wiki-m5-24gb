...
page_kind: source
summary: Claim-ledger projection (coding): 664 usable entries, 163 technical atoms, 122 needs-review, 92 linked page(s); write decision write-with-review-work.
sources: raw/coding_little_go_book.pdf
updated: 2026-06-26
domain: coding-little-go-book
category_path: sources
source_id: coding_little_go_book.pdf
projection_coverage: projection-coverage-f1be54fe65dc1c10@42caadfd8092bd55
---
...
- That said, we have to move forward. _(coding_little_go_book.pdf (source-range-810ce361-00013))_
- We have to be willing to take incremental steps because, again, languages are the foundation of what we do. _(coding_little_go_book.pdf (source-range-810ce361-00013))_
...
- You can build such systems with Ruby or Python or something else (and many people do), but these types of systems can benefit from a more rigid type system and greater performance. _(coding_little_go_book.pdf (source-range-810ce361-00016))_
...
- You don't have to worry if your users have Ruby or the JVM installed, and if so, what version. _(coding_little_go_book.pdf (source-range-810ce361-00017))_
- For this reason, Go is becoming increasingly popular as a language for command-line interface programs and other types of utility programs you need to distribute (e.g., a log collector). _(coding_little_go_book.pdf (source-range-810ce361-00017))_
...
- There are other areas where Go excels. _(coding_little_go_book.pdf (source-range-810ce361-00017))_
- For example, there are no dependencies when running a compiled Go program. _(coding_little_go_book.pdf (source-range-810ce361-00017))_
- Put plainly, learning Go is an efficient use of your time. _(coding_little_go_book.pdf (source-range-810ce361-00018))_
- You won't have to spend long hours learning or even mastering Go, and you'll end up with something practical from your effort. _(coding_little_go_book.pdf (source-range-810ce361-00018))_
...
- You can close and reopen your shell, or you can run source $HOME/.profile . _(coding_little_go_book.pdf (source-range-810ce361-00027))_

## Windows

- Environment variables can be set through the Environment Variables button on the Advanced tab of the System control panel. _(coding_little_go_book.pdf (source-range-810ce361-00030))_
...
- Compiled languages can be unpleasant to work with because compilation can be slow. _(coding_little_go_book.pdf (source-range-810ce361-00034))_
...
- Saying that a language has a C-like syntax means that if you're used to any other C-like languages such as C, C++, Java, JavaScript and C#, then you're going to find Go familiar -- superficially, at least. _(coding_little_go_book.pdf (source-range-810ce361-00039))_
- Saying that a language has a C-like syntax means that if you're used to any other C-like languages such as C, C++, Java, JavaScript and C#, then you're going to find Go familiar -- superficially, at least. _(coding_little_go_book.pdf (source-range-810ce361-00039))_
- C-like syntax also tends to mean semi-colon terminated lines and parentheses around conditions. _(coding_little_go_book.pdf (source-range-810ce361-00040))_
- Go does away with both of these, though parentheses are still used to control precedence. _(coding_little_go_book.pdf (source-range-810ce361-00040))_
...
- Beyond this, Go is much closer to C than C# or Java - not only in terms of syntax, but in terms of purpose. _(coding_little_go_book.pdf (source-range-810ce361-00044))_
- Beyond this, Go is much closer to C than C# or Java - not only in terms of syntax, but in terms of purpose. _(coding_little_go_book.pdf (source-range-810ce361-00044))_
...
- Without garbage collection, it's up to developers to free the memory associated with such variables at a point where the developer knows the variable isn't needed. _(coding_little_go_book.pdf (source-range-810ce361-00046))_
- Some variables, when created, have an easy-to-define life. _(coding_little_go_book.pdf (source-range-810ce361-00046))_
- A variable local to a function, for example, disappears when the function exits. _(coding_little_go_book.pdf (source-range-810ce361-00046))_
- Languages with garbage collectors (e.g., Ruby, Python, Java, JavaScript, C#, Go) are able to keep track of these and free them when they're no longer used. _(coding_little_go_book.pdf (source-range-810ce361-00047))_
- Garbage collection adds overhead, but it also eliminates a number of devastating bugs. _(coding_little_go_book.pdf (source-range-810ce361-00047))_
...
- We'll slowly build larger examples and hopefully, the pieces will start to come together. _(coding_little_go_book.pdf (source-range-810ce361-00107))_
- We looked at a number of small individual pieces and it probably feels disjointed at this point. _(coding_little_go_book.pdf (source-range-810ce361-00107))_
- For some systems, dynamic languages are categorically more productive. _(coding_little_go_book.pdf (source-range-810ce361-00108))_
- If you're coming from a statically typed language, you're probably feeling comfortable with Go. _(coding_little_go_book.pdf (source-range-810ce361-00109))_

## Chapter 2 - Structures

- It doesn't have objects nor inheritance and thus, doesn't have the many concepts associated with OO such as polymorphism and overloading. _(coding_little_go_book.pdf (source-range-810ce361-00111))_
- Go isn't an object-oriented (OO) language like C++, Java, Ruby and C#. _(coding_little_go_book.pdf (source-range-810ce361-00111))_
- It doesn't have objects nor inheritance and thus, doesn't have the many concepts associated with OO such as polymorphism and overloading. _(coding_little_go_book.pdf (source-range-810ce361-00111))_
- Go also supports a simple but effective form of composition. _(coding_little_go_book.pdf (source-range-810ce361-00112))_
- Overall, it results in simpler code, but there'll be occasions where you'll miss some of what OO has to offer. _(coding_little_go_book.pdf (source-range-810ce361-00112))_
- (It's worth pointing out that composition over inheritance is an old battle cry and Go is the first language I've used that takes a firm stand on the issue.) _(coding_little_go_book.pdf (source-range-810ce361-00112))_
...
- From a practical point of view, this chapter introduced structures, how to make an instance of a structure a receiver of a function, and added pointers to our existing knowledge of Go's type system. _(coding_little_go_book.pdf (source-range-810ce361-00187))_
...
- There are edge cases that we haven't covered, but you're not likely to run into them. _(coding_little_go_book.pdf (source-range-810ce361-00270))_
- If you're used to dynamic arrays, there might be a small adjustment, but append should solve most of your discomfort. _(coding_little_go_book.pdf (source-range-810ce361-00270))_
- Slices are powerful and they have a surprisingly large impact on the clarity of your code. _(coding_little_go_book.pdf (source-range-810ce361-00270))_
- And, if you do, hopefully the foundation we've built here will let you understand what's going on. _(coding_little_go_book.pdf (source-range-810ce361-00270))_
...
- Ultimately, how you structure your code around Go's workspace is something that you'll only feel comfortable with after you've written a couple of non-trivial projects. _(coding_little_go_book.pdf (source-range-810ce361-00333))_
...
- There are a few things we haven't looked at, such as constants and global variables but rest assured, their visibility is determined by the same naming rule. _(coding_little_go_book.pdf (source-range-810ce361-00334))_
- There are a few things we haven't looked at, such as constants and global variables but rest assured, their visibility is determined by the same naming rule. _(coding_little_go_book.pdf (source-range-810ce361-00334))_
...
- However, the first time you see a function that expects something like io.Reader , you'll find yourself thanking the author for not demanding more than he or she needed. _(coding_little_go_book.pdf (source-range-810ce361-00335))_
- Finally, if you're new to interfaces, it might take some time before you get a feel for them. _(coding_little_go_book.pdf (source-range-810ce361-00335))_
...
- This lets you release resources near where it's initialized and takes care of multiple return points. _(coding_little_go_book.pdf (source-range-810ce361-00354))_
- The point is to show how defer works. _(coding_little_go_book.pdf (source-range-810ce361-00354))_
- Whatever you defer will be executed after the enclosing function (in this case main() ) returns, even if it does so violently. _(coding_little_go_book.pdf (source-range-810ce361-00354))_
- Whatever you defer will be executed after the enclosing function (in this case main() ) returns, even if it does so violently. _(coding_little_go_book.pdf (source-range-810ce361-00354))_
...
```
_(source: coding_little_go_book.pdf (source-range-810ce361-00353))_

## go fmt

- Most programs written in Go follow the same formatting rules, namely, a tab is used to indent and braces go on the same line as their statement. _(coding_little_go_book.pdf (source-range-810ce361-00356))_
- I know, you have your own style and you want to stick to it. _(coding_little_go_book.pdf (source-range-810ce361-00357))_
- It's easy to use and authoritative (so no one argues over meaningless preferences). _(coding_little_go_book.pdf (source-range-810ce361-00357))_
- That's what I did for a long time, but I'm glad I eventually gave in. _(coding_little_go_book.pdf (source-range-810ce361-00357))_
- A big reason for this is the go fmt command. _(coding_little_go_book.pdf (source-range-810ce361-00357))_
- When you're inside a project, you can apply the formatting rule to it and all sub-projects via: _(coding_little_go_book.pdf (source-range-810ce361-00358))_
- When you're inside a project, you can apply the formatting rule to it and all sub-projects via: _(coding_little_go_book.pdf (source-range-810ce361-00358))_
...
go	fmt	./...
```
_(source: coding_little_go_book.pdf (source-range-810ce361-00359))_
...
- We looked at various aspects of programming with Go. _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Yet, I also find that it results in code that's easier to follow. _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- In fact, it isn't tied to resource management only. _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- You can use defer for any purpose, such as logging when a function exits. _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Most notably, we saw how error handling behaves and how to release resources such as connections and open files. _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Certainly, we haven't looked at all of the tidbits Go has to offer. _(coding_little_go_book.pdf (source-range-810ce361-00395))_
- But you should be feeling comfortable enough to tackle whatever you come across. _(coding_little_go_book.pdf (source-range-810ce361-00395))_
...
- Go is often described as a concurrent-friendly language. _(coding_little_go_book.pdf (source-range-810ce361-00397))_
...
- Our worker is simple. _(coding_little_go_book.pdf (source-range-810ce361-00429))_
- Dutifully, it does this in a loop, forever waiting for more data to process. _(coding_little_go_book.pdf (source-range-810ce361-00429))_
- It waits until data is available then "processes" it. _(coding_little_go_book.pdf (source-range-810ce361-00429))_
- It waits until data is available then "processes" it. _(coding_little_go_book.pdf (source-range-810ce361-00429))_
- We don't know which worker is going to get what data. _(coding_little_go_book.pdf (source-range-810ce361-00430))_
- Notice that the only shared state is the channel, which we can safely receive from and send to concurrently. _(coding_little_go_book.pdf (source-range-810ce361-00431))_
...
id	int
```
_(source: coding_little_go_book.pdf (source-range-810ce361-00428))_
...
- If you're new to the world of concurrent programming, it might all seem rather overwhelming. _(coding_little_go_book.pdf (source-range-810ce361-00467))_
- Go aims to make it easier. _(coding_little_go_book.pdf (source-range-810ce361-00467))_
...
- Having said that, I still make extensive use of the various synchronization primitives found in the sync and sync/atomic packages. _(coding_little_go_book.pdf (source-range-810ce361-00469))_
- I encourage you to first focus on channels, but when you see a simple example that needs a short-lived lock, consider using a mutex or readwrite mutex. _(coding_little_go_book.pdf (source-range-810ce361-00469))_

## Conclusion

- Perhaps, I did this reality a disservice. _(coding_little_go_book.pdf (source-range-810ce361-00471))_
...
- I recently heard Go described as a boring language. _(coding_little_go_book.pdf (source-range-810ce361-00471))_
- Boring because it's easy to learn, easy to write and, most importantly, easy to read. _(coding_little_go_book.pdf (source-range-810ce361-00471))_
- We did spend three chapters talking about types and how to declare variables after all. _(coding_little_go_book.pdf (source-range-810ce361-00471))_
- If you have a background in a statically typed language, much of what we saw was probably, at best, a refresher. _(coding_little_go_book.pdf (source-range-810ce361-00472))_
- That Go makes pointers visible and that slices are thin wrappers around arrays probably isn't overwhelming to seasoned Java or C# developers. _(coding_little_go_book.pdf (source-range-810ce361-00472))_
- It is a fair bit to learn. _(coding_little_go_book.pdf (source-range-810ce361-00473))_
- If you've mostly been making use of dynamic languages, you might feel a little different. _(coding_little_go_book.pdf (source-range-810ce361-00473))_
- Despite being a fan of Go, I find that for all the progress towards simplicity, there's something less than simple about it. _(coding_little_go_book.pdf (source-range-810ce361-00473))_
...
- Still, it comes down to some basic rules (like you can only declare variable once and := does declare the variable) and fundamental understanding (like new(X) or &X{} only allocate memory, but slices, maps and channels require more initialization and thus, make ). _(coding_little_go_book.pdf (source-range-810ce361-00473))_
- Still, it comes down to some basic rules (like you can only declare variable once and := does declare the variable) and fundamental understanding (like new(X) or &X{} only allocate memory, but slices, maps and channels require more initialization and thus, make ). _(coding_little_go_book.pdf (source-range-810ce361-00473))_
...
- They are almost their own fundamental building block. _(coding_little_go_book.pdf (source-range-810ce361-00475))_
- Given how hard concurrent programming can be, that is definitely a good thing. _(coding_little_go_book.pdf (source-range-810ce361-00475))_
- Last but not least is the built-in support for concurrency. _(coding_little_go_book.pdf (source-range-810ce361-00475))_
...
- I say this because they change how you write and think about concurrent programming. _(coding_little_go_book.pdf (source-range-810ce361-00475))_

> I always think it's important to understand basics before using high-level wrappers.
_(source: coding_little_go_book.pdf (source-range-810ce361-00475))_
...
- Compiled languages can be unpleasant to work with because compilation can be slow. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00034))_
...
- A variable local to a function, for example, disappears when the function exits. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00046))_
- In other cases, it isn't so obvious -- at least to a compiler. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00046))_
- In C, you'd literally free(str); the variable. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00046))_
...
- len returns the size of a string, or the number of values in a dictionary, or, as we see here, the number of elements in an array. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00063))_
- We're now using two of Go's standard packages: fmt and os . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00063))_
- We'll learn more about packages in later chapters. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00064))_
- Also, scroll to the top to learn more about Go's formatting capabilities. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00068))_
- Still, it'll probably take some time before you truly feel comfortable with it. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00073))_
- By default, Go assigns a zero value to variables. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00077))_
- Here, we declare a variable power of type int . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00077))_
- Next, we assign 9000 to our power variable. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00077))_
- Still, that's a lot of typing. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00079))_
- If you try to run the following, you'll get an error. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00083))_
- There's more to learn about declaration and assignments. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00094))_
- Sometimes, you only care about one of the return values. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00100))_
- Finally, there's something else that you're likely to run into with function declarations. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00103))_
- Still, you'll run into all of these sooner than later so it's important to know about them. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00105))_
- Being able to return multiple values is something you'll use often. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00105))_
- Named return values and the slightly less verbose parameter declaration aren't that common. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00105))_
- I don't disagree with you. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00108))_
- Inferred types and multiple return values are nice (though certainly not exclusive to Go). — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00109))_
- Hopefully as we learn more, you'll appreciate the clean and terse syntax. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00109))_
- It comes down to the way Go passes arguments to a function: as copies. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00128))_
- We made two changes. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00132))_
- Think of it as copying the directions to a restaurant. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00133))_
- The above, once again, prints 9000. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00136))_
- This pattern rubs a lot of developers the wrong way. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00147))_
- Many people think that it's a more robust way to share code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00167))_
- Simply, Go doesn't support overloading. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00169))_
- While overloading isn't specific to structures, it's worth addressing. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00169))_
- For this reason, you'll see (and write) a lot of functions that look like Load , LoadById , LoadByName and so on. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00169))_
- - Return value from a function — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00177))_
- - The receiver of a method — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00179))_
- Even if you don't intend to change the data, consider the cost of creating a copy of large structures. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00182))_
- So far we've seen a number of simple types and structures. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00189))_
- It's now time to look at arrays, slices and maps. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00189))_
- For this, we turn to slices. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00198))_
- In the above, we initialize a slice with a length of 10 and a capacity of 10. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00204))_
- This creates a slice with a length of 0 but with a capacity of 10. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00206))_
- To better understand the interplay between length and capacity, let's look at some examples: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00207))_
- Our first example crashes. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00209))_
- But that changes the intent of our original code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00211))_
- If I told you that Go grew arrays with a 2x algorithm, can you guess what the following will output? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00214))_
- The [X:Y] syntax creates a slice of scores , starting from index 2 up until (but not including) index 4. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00234))_
- Unlike other languages, Go doesn't support negative values. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00239))_
- Take some time and play with the above code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00246))_
- Maps grow dynamically. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00253))_
- There's yet another way to declare and initialize values in Go. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00260))_
- At this point, the same logic that we saw in Chapter 2 applies. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00268))_
- So with respect to passing/returning the slice itself, there's no difference. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00268))_
- If we peek beyond the superficial syntax of arrays, we find slices. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00270))_
- It's now time to look at how to organize our code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00272))_
- Also, obviously, we aren't actually accessing the database. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00277))_
- This happens when package A imports package B but package B imports package A (either directly or indirectly through another package). — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00286))_
- As you start writing more complex systems, you're bound to run into cyclical imports. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00286))_
- Let's change our shopping structure to cause the error. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00287))_
- Move the Item definition from shopping/db/db.go into shopping/pricecheck.go . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00288))_
- If it starts with a lowercase letter, it isn't. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00299))_
- If the name of the type or function starts with an uppercase letter, it's visible. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00299))_
- This also applies to structure fields. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00300))_
- Go ahead and change the name of the various functions, types and fields from the shopping code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00304))_
- Go ahead and check your $GOPATH/src . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00309))_
- go get fetches the remote files and stores them in your workspace. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00309))_
- I know this looks like a URL but in reality, it'll simply import the gosqlite3 package which it expects to find in $GOPATH/src/github.com/mattn/go-sqlite3 . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00312))_
- Interfaces help decouple your code from specific implementations. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00321))_
- How would you use one? Just like any other type, it could be a structure's field: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00324))_
- This cuts down on the verboseness of using interfaces: } public class ConsoleLogger : Logger { public void Logger(message string) { Console.WriteLine(message) } } type ConsoleLogger struct {} (l ConsoleLogger) Log(message string) { — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00327))_
- In this chapter, we'll talk about a miscellany of Go's feature which didn't quite fit anywhere else. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00337))_
- Consider the strconv.Atoi function which takes a string and tries to convert it to an integer: — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00339))_
- There's a common pattern in Go's standard library of using error variables. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00346))_
- If you try to run the above code, you'll probably get an error (the file doesn't exist). — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00354))_
- That's a pretty silly example. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00364))_
- Admittedly, it won't result in clean code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00376))_
- Do note that when you use []byte(X) or string(X) , you're creating a copy of the data. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00382))_
- Of course, when you turn a string into a []byte you'll get the correct data. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00385))_
- If you iterate over a string using range , you'll get runes, not bytes. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00385))_
- Using functions like this can help decouple code from specific implementations much like we achieve with interfaces. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00392))_
- Most notably, we saw how error handling behaves and how to release resources such as connections and open files. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Yet, I also find that it results in code that's easier to follow. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Many people dislike Go's approach to error handling. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00394))_
- Do note that anonymous functions aren't only used with goroutines, however. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00402))_
- What do you think the output will be? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00412))_
- It's true that if you run the above code, you'll sometimes get that output. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00413))_
- 20 you're both right and wrong. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00413))_
- A mutex serializes access to the code under lock. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00417))_
- In addition to the Lock and Unlock methods of a sync.Mutex , it also exposes RLock and RUnlock methods; where R stands for Read . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00423))_
- This exposes two locking functions: one to lock for reading and one to lock for writing. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00423))_
- There's more to concurrent programming than what we've seen so far. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00423))_
- Furthermore, part of concurrent programming isn't so much about serializing access across the narrowest possible piece of code; it's also about coordinating multiple goroutines. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00424))_
- For example, sleeping for 10 milliseconds isn't a particularly elegant solution. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00424))_
- Given the above code, what happens if we have more data coming in than we can handle? You can simulate this by changing the worker to sleep after it has received data: — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00433))_
- Buffered channels don't add more capacity; they merely provide a queue for pending work and a good way to deal with a sudden spike. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00438))_
- We're willing to block for some time, but not forever. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00450))_
- There's nothing more magical than that. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00453))_
- select works the same regardless of whether we're receiving from, sending to, or any combination of channels: — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00459))_
- Pay close attention to our select . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00459))_
- Notice that we're sending to c but receiving from time.After . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00459))_
- - If there's no default, select blocks. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00463))_
- Finally, it's common to see a select inside a for . — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00464))_
- It categorically demands considerably more attention and care. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00467))_
- This doesn't just eliminate bugs, but it changes how one approaches concurrent programming. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00468))_
- You start to think about concurrency with respect to message passing, rather than dangerous areas of code. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00468))_
- Boring because it's easy to learn, easy to write and, most importantly, easy to read. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00471))_
- I say this because they change how you write and think about concurrent programming. — _fragmentary: no subject/predicate region recovered_ _(coding_little_go_book.pdf (source-range-810ce361-00475))_
