---
page_id: coding-little-go-book-basic
page_kind: concept
summary: The Basics: 66 statement(s) and 26 atom(s) from raw/coding_little_go_book.pdf.
sources: raw/coding_little_go_book.pdf
updated: 2026-06-29
domain: coding-little-go-book
category_path: concepts
projection_coverage: topic-coding-little-go-book-basic@0e16bab9e64cd13618fe2e29be763cdf
---

# The Basics

What [[coding-little-go-book]] covers about the basics:
...
### Technical frame 14: Chapter 1 - The Basics / Variables and Declarations
...
### Technical frame 15: Chapter 1 - The Basics / Variables and Declarations
...
### Technical frame 23: Chapter 1 - The Basics / Function Declarations
...
### Technical frame 24: Chapter 1 - The Basics / Function Declarations
...
- [[coding-little-go-book-variable-and-declaration]] - shared statements and technical atoms: Variables and Declarations shares source evidence from Chapter 1 - The Basics / Variables and Declarations: It'd be nice to begin and end our look at variables by saying you declare and assign to a variable by doing x = 4. Unfortunately, things are more complicated in Go. ... [truncated]; Variables and Declarations shares technical record from Chapter 1 - The Basics / Variables and Declarations: package main import ( "fmt" ) func main() { var power int power = 9000 fmt.Printf("It's over %d\n", power) } (18 shared statement(s), 9 shared atom(s))
...
- [[coding-little-go-book-import]] - shared statements and technical atoms: Imports shares source evidence from Chapter 1 - The Basics / Imports: Go has a number of built-in functions, such as println , which can be used without reference. We can't get very far though, without making use of Go's standard libra ... [truncated]; Imports shares technical record from Chapter 1 - The Basics / Imports: func main() { if len(os.Args) != 2 { os.Exit(1) } fmt.Println("It's over", os.Args[1]) } (12 shared statement(s), 7 shared atom(s))
- [[coding-little-go-book-running-code]] - shared statements and technical atoms: Running Go Code shares source evidence from Chapter 1 - The Basics / Running Go Code: Save the file as main.go . For now, you can save it anywhere you want; we don't need to live inside Go's workspace for trivial examples.; Running Go Code shares technical record from Chapter 1 - The Basics / Running Go Code: package main func main() { println("it's over 9000!") } (8 shared statement(s), 3 shared atom(s))
- [[coding-little-go-book-language]] - shared statements: Language shares source evidence from Chapter 1 - The Basics / C-Like Syntax: Saying that a language has a C-like syntax means that if you're used to any other C-like languages such as C, C++, Java, JavaScript and C#, then you're going to find ... [truncated] (3 shared statement(s))
- [[coding-little-go-book-section-chapter-1-the-basics-45e21143]] - source section: Chapter 1 - The Basics shares source evidence from Chapter 1 - The Basics: Go is a compiled, statically typed language with a C-like syntax and garbage collection. What does that mean?; Chapter 1 - The Basics shares technical record from Chapter 1 - The Basics / Compilation: It's hard to iterate quickly if you have to spend minutes or hours waiting for code to compile. (66 shared statement(s), 26 shared atom(s))
