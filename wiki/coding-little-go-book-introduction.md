---
page_id: coding-little-go-book-introduction
page_kind: concept
summary: Introduction: 24 statement(s) and 2 atom(s) from raw/coding_little_go_book.pdf.
sources: raw/coding_little_go_book.pdf
updated: 2026-06-29
domain: coding-little-go-book
category_path: concepts
projection_coverage: topic-coding-little-go-book-introduction@53e210b996aea4af55be06864e3693b2
---

# Introduction

What [[coding-little-go-book]] covers about introduction:
...
- [[coding-little-go-book-language]] - shared statements and technical atoms: Language shares source evidence from Introduction: I've always had a love-hate relationship when it comes to learning new languages. On the one hand, languages are so fundamental to what we do, that even small change ... [truncated]; Language shares technical record from Introduction: I've always had a love-hate relationship when it comes to learning new languages. (2 shared statement(s), 1 shared atom(s))
- [[coding-little-go-book-section-introduction-9630c91e]] - source section: Introduction shares source evidence from Introduction: I've always had a love-hate relationship when it comes to learning new languages. On the one hand, languages are so fundamental to what we do, that even small change ... [truncated]; Introduction shares technical record from Introduction: I've always had a love-hate relationship when it comes to learning new languages. (24 shared statement(s), 2 shared atom(s))
