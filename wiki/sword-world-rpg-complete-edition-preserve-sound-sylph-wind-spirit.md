...
- Base Mental Power Cost=30 Distance=10 meters Area=A space with a 5 meter radius Duration=Until sound is transmitted Effect=Record and transmit sound to a specific location Type=Expansion=Distance, area Resist=None. (Sword World RPG - Complete Edition.pdf p.92)
...
- This spell has the effect of recording a sound and transmitting it to a specific location. (Sword World RPG - Complete Edition.pdf p.92)
...
- It's also not possible to use this to record spells and activate them. (Sword World RPG - Complete Edition.pdf p.92)
