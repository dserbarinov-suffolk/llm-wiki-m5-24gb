...
aliases: maybe
projection_coverage: recipe-javascriptallonge-recipe-maybe@edd0b37dd58f7362eece11eea793517b
---
...
- Use the source-backed pattern described in [[javascriptallonge-section-recipes-with-basic-functions-maybe-c5a7d5d9]].
- Evidence roles: decision, constraint, example, structured-state.

## Applicability And Rationale

- A common problem in programming is checking for null or undefined (hereafter called 'nothing,' while all other values including 0 , [] and false will be called 'something'). _(javascriptallonge.pdf (source-range-c98ab3e6-00690))_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00692)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00698)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00700)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00702)_
...
- Source section: [[javascriptallonge-section-recipes-with-basic-functions-maybe-c5a7d5d9]]
