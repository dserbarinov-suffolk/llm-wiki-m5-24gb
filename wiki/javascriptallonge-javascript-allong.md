...
page_kind: concept
summary: About JavaScript Allongé: 49 statement(s) and 9 atom(s) from raw/javascriptallonge.pdf.
...
**Context:** _(javascriptallonge.pdf (source-range-c98ab3e6-00025))_
...
**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00024))_

<a id="atom-technical-atom-da6dc7cb7d76243d"></a>
```
