---
page_id: rpg-cairn-2e-core-section-scars-c3c30834
page_kind: source
...
projection_coverage: section-rpg-cairn-2e-core-section-scars-c3c30834@b7dad4ec8915603ca2c3e39846dc7743
---
...
- If damage to a PC would reduce their HP to exactly 0, look up the result on the table below based on the amount of HP lost in the attack . _(rpg_cairn_2e_core.pdf (source-range-bc2972ae-00238))_
- For example, if a PC went from 3 HP to 0 HP , they would look at entry #3 (Walloped). _(rpg_cairn_2e_core.pdf (source-range-bc2972ae-00238))_
- For example, if a PC went from 3 HP to 0 HP , they would look at entry #3 (Walloped). _(rpg_cairn_2e_core.pdf (source-range-bc2972ae-00238))_
