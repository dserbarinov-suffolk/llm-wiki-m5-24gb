...
What [[rpg-cairn-2e-core]] covers about character:

## Statements

### Overview & Principles / Overview / Death

- Characters may be powerful, but they are also vulnerable to harm in its many forms. Death is always around the corner, but it is never random or without warning. _(rpg_cairn_2e_core.pdf (source-range-9b4fff26-00013))_

### Overview & Principles / Principles for Players / Agency
...
- Attributes are not universal descriptors. A character with a low STR is not necessarily hopelessly weak; they can still attempt to lift a heavy door or survive a deadly fight! Their risk is simply higher. _(rpg_cairn_2e_core.pdf (source-range-9b4fff26-00103))_
...
- slots) is reduced to 0 HP . A character cannot fill more than ten slots. _(rpg_cairn_2e_core.pdf (source-range-9b4fff26-00111))_

### Core Rules / Saves

- A save is a roll to avoid negative outcomes from risky choices. Characters roll a d20 and compare the results to the appropriate attribute. If they roll equal to or under that attribute, they succeed. Otherwise, they fail. A 1 is always a success, and a 20 is always a failure. _(rpg_cairn_2e_core.pdf (source-range-9b4fff26-00163))_
...
### Core Rules / Deprivation & Fatigue
...
- Character death should never come as a surprise. If the risk is so great that the outcome might be fatal, make sure the player understands what they're getting into. _(rpg_cairn_2e_core.pdf (source-range-9b4fff26-00506))_
...
### Bonds and Omens / Omens / Omens Should...
...
### Technical frame 1: Character Creation / Backgrounds
...
### Technical frame 11: Procedures / Dungeon Exploration / Dungeon Exploration Cycle
...
### Technical frame 12: Procedures / Dungeon Exploration / Dungeon Exploration Cycle
