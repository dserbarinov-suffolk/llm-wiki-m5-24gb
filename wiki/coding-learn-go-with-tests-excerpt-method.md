...
page_kind: concept
summary: What are methods?: 19 statement(s) and 11 atom(s) from raw/coding_learn_go_with_tests_excerpt.pdf.
sources: raw/coding_learn_go_with_tests_excerpt.pdf
updated: 2026-06-29
domain: coding-learn-go-with-tests-excerpt
category_path: concepts
projection_coverage: topic-coding-learn-go-with-tests-excerpt-method@08fa60da88227d4b23d2e920281f3631
---
...
- [[coding-learn-go-with-tests-excerpt-test]] - shared statements: Test shares source evidence from What are methods? / Write enough code to make it pass: If you re-run the tests the rectangle tests should be passing but circle should still be failing. (1 shared statement(s))
- [[coding-learn-go-with-tests-excerpt-type]] - shared statements: Type shares source evidence from What are methods? / Refactor: We're creating a new type just like we did with Rectangle and Circle but this time it is an interface rather than a struct . (1 shared statement(s))
- [[coding-learn-go-with-tests-excerpt-section-what-are-methods-997bc0f7]] - source section: What are methods? shares source evidence from What are methods?: So far we have only been writing functions but we have been using some methods. When we call t.Errorf we are calling the method Errorf on the instance of our t ( testing.T ).; What are methods? shares technical record from What are methods?: func TestArea(t *testing.T) { t.Run("rectangles", func(t *testing.T) { rectangle := Rectangle{12, 6} got := rectangle.Area() want := 72.0 if got != want { t.Errorf(" ... [truncated] (19 shared statement(s), 11 shared atom(s))
