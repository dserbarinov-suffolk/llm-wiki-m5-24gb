---
page_id: javascriptallonge-section-tail-call-optimization-d8a69702
page_kind: source
summary: tail-call optimization: 18 source-backed entries and 0 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-tail-call-optimization-d8a69702@9a7d77272c56e01341ca2809a8e3c8c6
---
...
- [[javascriptallonge-section-tail-calls-and-default-arguments-95fbdaba]] - previous source section: Tail Calls (and Default Arguments)
- [[javascriptallonge-section-converting-non-tail-calls-to-tail-calls-88056a4f]] - next source section: converting non-tail-calls to tail-calls
