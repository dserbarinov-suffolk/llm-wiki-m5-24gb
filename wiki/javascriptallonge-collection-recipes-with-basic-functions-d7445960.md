---
page_id: javascriptallonge-collection-recipes-with-basic-functions-d7445960
page_kind: source
...
Broader source section: [[javascriptallonge-section-recipes-with-basic-functions-d7445960]].
...
| --- | --- | --- |
| Recipes with Basic Functions / Partial Application | [[javascriptallonge-section-recipes-with-basic-functions-partial-application-70ce84b0]] | 5 statement(s), 9 atom(s) |
| Recipes with Basic Functions / Unary | [[javascriptallonge-section-recipes-with-basic-functions-unary-d494fe78]] | 9 statement(s), 28 atom(s) |
