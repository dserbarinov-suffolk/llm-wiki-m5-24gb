---
page_id: javascriptallonge-section-ecmascript-6-has-three-major-groups-of-features-forewords-to-the-first-edition-3792fa5b
page_kind: source
summary: ECMAScript 6 has three major groups of features: / Forewords to the First Edition: 15 source-backed entries and 1 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-ecmascript-6-has-three-major-groups-of-features-forewords-to-the-first-edition-3792fa5b@e5be7e631600f6a60be11a461a958211
---

# ECMAScript 6 has three major groups of features: / Forewords to the First Edition
...
- [[javascriptallonge-section-ecmascript-6-has-three-major-groups-of-features-316fded8]] - broader source section: ECMAScript 6 has three major groups of features:
- [[javascriptallonge-section-ecmascript-6-has-three-major-groups-of-features-forewords-to-the-first-edition-matthew-knox-5bc8596f]] - narrower source section: ECMAScript 6 has three major groups of features: / Forewords to the First Edition / matthew knox
...
- Not only was this a great book, but it was also a great way to write and distribute books. _(javascriptallonge.pdf (source-range-c98ab3e6-00083))_
- However, the process of soliciting feedback, gathering responses, sending out copies, waiting for people to actually read it (if they ever do), receiving feedback and then ultimately making sense out of how to use it takes weeks and sometimes months. _(javascriptallonge.pdf (source-range-c98ab3e6-00084))_
- Reg has crafted (and continues to craft) not only an interesting book from the perspective of a connoisseur, but also an entertaining exploration into some of the most interesting aspects of his art. _(javascriptallonge.pdf (source-range-c98ab3e6-00085))_

## Technical atoms

### Technical frame 1: ECMAScript 6 has three major groups of features: / Forewords to the First Edition / matthew knox

**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00090))_

<a id="atom-technical-atom-3b3eb146c991a666"></a>
```text
matthew knox
