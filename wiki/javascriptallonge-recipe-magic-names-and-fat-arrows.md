...
projection_coverage: recipe-javascriptallonge-recipe-magic-names-and-fat-arrows@25faa51179310f6651fd2169fb46cccd
---
...
- Use the source-backed pattern described in [[javascriptallonge-section-and-also-magic-names-magic-names-and-fat-arrows-99d137a1]].
...
- But if we use a fat arrow, arguments will be defined in the outer environment, the one defined with function . _(javascriptallonge.pdf (source-range-c98ab3e6-00617))_
...
- It uses mapWith , which we discussed in Building Blocks. _(javascriptallonge.pdf (source-range-c98ab3e6-00620))_
- To give a contrived example, this function takes a number and returns an array representing a row in a hypothetical multiplication table. _(javascriptallonge.pdf (source-range-c98ab3e6-00620))_

## Technical Atoms

### Atom 1: `code-block`

_Source: javascriptallonge.pdf (source-range-c98ab3e6-00616)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00618)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00621)_
...
_Source: javascriptallonge.pdf (source-range-c98ab3e6-00624)_
...
- Source section: [[javascriptallonge-section-and-also-magic-names-magic-names-and-fat-arrows-99d137a1]]
