---
page_id: rpg-cairn-2e-core-attack
page_kind: concept
summary: Attack: 5 statement(s) and 6 atom(s) from raw/rpg_cairn_2e_core.pdf.
sources: raw/rpg_cairn_2e_core.pdf
updated: 2026-06-26
domain: rpg-cairn-2e-core
category_path: concepts
projection_coverage: topic-rpg-cairn-2e-core-attack@ae35aa49e2f41ed06b52cb50df897921
---

# Attack

What [[rpg-cairn-2e-core]] covers about attack:
...
- The attacker rolls their weapon die and subtracts the target's armor, then deals the remaining total to their opponent's HP . _(rpg_cairn_2e_core.pdf (source-range-bc2972ae-00211))_
- If an attack would take a PC's HP exactly to 0, refer to the Scars table to see how they are uniquely impacted. _(rpg_cairn_2e_core.pdf (source-range-bc2972ae-00213))_
...
_(context: rpg_cairn_2e_core.pdf (source-range-bc2972ae-00216, source-range-bc2972ae-00218))_

> If unsure how many targets can be affected, roll the related damage die for a result .
_(source: rpg_cairn_2e_core.pdf (source-range-bc2972ae-00217))_
