...
1. **Difficulty** (`step`) - evidence section [[sword-world-rpg-complete-edition-section-2-5-difficulty-checks-2-5-1-difficulty-24f6c32c]].
   - What makes this different from a target score is that this is not the direct number the player is aiming for. _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-00999))_
2. **How to Make a Difficulty Check** (`validate`) - evidence section [[sword-world-rpg-complete-edition-section-2-5-difficulty-checks-2-5-2-how-to-make-a-difficulty-check-6d909d75]].
   ...
   - The game master does not reveal their roll nor the target score that results from their calculation, to the players. _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-01001))_
   - To make a difficulty check , the game master also rolls the dice (2D). _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-01001))_
3. **Analogy of Success and Failure** (`generate`) - evidence section [[sword-world-rpg-complete-edition-section-2-5-difficulty-checks-2-5-3-analogy-of-success-and-failure-86286098]].
   - That is precisely the reason why we use difficulty checks. _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-01010))_
   - If a success roll is made for a difficulty check, the success or failure of the action is strictly unknown to the player. _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-01010))_
...
- Source section: [[sword-world-rpg-complete-edition-section-2-5-difficulty-checks-d95d8c9d]]
