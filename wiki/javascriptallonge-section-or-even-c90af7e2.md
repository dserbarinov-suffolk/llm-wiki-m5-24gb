---
page_id: javascriptallonge-section-or-even-c90af7e2
page_kind: source
...
projection_coverage: section-javascriptallonge-section-or-even-c90af7e2@6e3f1883be2aabf6daebd3678f0647e1
---
...
- [[javascriptallonge-section-the-first-sip-basic-functions-ebb517fa]] - previous source section: The first sip: Basic Functions
- [[javascriptallonge-section-and-also-5c5088c6]] - next source section: And also:

### Source structure

- [[javascriptallonge-section-or-even-back-on-the-block-2c916353]] - narrower source section: Or even: / back on the block
- [[javascriptallonge-section-or-even-the-simplest-possible-block-cef121f0]] - narrower source section: Or even: / the simplest possible block
- [[javascriptallonge-section-or-even-void-b48c3fc8]] - narrower source section: Or even: / void

## Statements by subsection

### Or even: / the simplest possible block

- There's another thing we can put to the right of an arrow, a block . A block has zero or more statements , separated by semicolons. 18 _(javascriptallonge.pdf (source-range-c98ab3e6-00212))_
...
- We haven't discussed these statements . What's a statement? _(javascriptallonge.pdf (source-range-c98ab3e6-00240))_
- There are many kinds of JavaScript statements, but the first kind is one we've already met. An expression is a JavaScript statement. Although they aren't very practical, these are valid JavaScript functions, and they return undefined when applied: _(javascriptallonge.pdf (source-range-c98ab3e6-00241))_
...
**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00210))_

<a id="atom-technical-atom-dc40f72e37f27d14"></a>
```
() => (
1 + 1,
2 + 2
...
**Context:** _(javascriptallonge.pdf (source-range-c98ab3e6-00240))_

> We haven't discussed these statements . What's a statement?

**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00237))_

<a id="atom-technical-atom-247cb8e0e91b0fe8"></a>
```
(() => {})()
//=> undefined
```
...
**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00244))_

<a id="atom-technical-atom-ba885dd48492b591"></a>
```
() => {
1 + 1;
2 + 2
