---
page_id: javascriptallonge-section-prelude-values-and-expressions-over-coffee-reference-types-11fd4275
page_kind: source
summary: Prelude: Values and Expressions over Coffee / reference types: 8 source-backed entries and 0 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-prelude-values-and-expressions-over-coffee-reference-types-11fd4275@e155585e548cc8e350fa6570902ad288
---
...
- [[javascriptallonge-section-prelude-values-and-expressions-over-coffee-value-types-cb5b0b74]] - previous source section: Prelude: Values and Expressions over Coffee / value types
...
- [[javascriptallonge-recipe-reference-types]] - recipe pattern: reference types
