...
projection_coverage: topic-coding-little-go-book-declaration-and-initialization@96ff4872eadde478e3ac8682cdd8eb04
---
...
- [[coding-little-go-book-structure]] - shared statements and technical atoms: Structures shares source evidence from Chapter 2 - Structures / Declarations and Initializations: When we first looked at variables and declarations, we looked only at built-in types, like integers and strings. Now that we're talking about structures, we need to ... [truncated]; Structures shares technical record from Chapter 2 - Structures / Declarations and Initializations: goku := Saiyan{ Name: "Goku", Power: 9000, } (27 shared statement(s), 7 shared atom(s))
- [[coding-little-go-book-value]] - shared statements and technical atoms: Value shares source evidence from Chapter 2 - Structures / Declarations and Initializations: The answer is 9000, not 19000. Why? Because Super made changes to a copy of our original goku value and thus, changes made in Super weren't reflected in the caller. ... [truncated]; Value shares technical record from Chapter 2 - Structures / Declarations and Initializations: goku := Saiyan{ Name: "Goku", Power: 9000, } (3 shared statement(s), 5 shared atom(s))
- [[coding-little-go-book-section-chapter-2-structures-declarations-and-initializations-aa4f849c]] - source section: Chapter 2 - Structures / Declarations and Initializations shares source evidence from Chapter 2 - Structures / Declarations and Initializations: When we first looked at variables and declarations, we looked only at built-in types, like integers and strings. Now that we're talking about structures, we need to ... [truncated]; Chapter 2 - Structures / Declarations and Initializations shares technical record from Chapter 2 - Structures / Declarations and Initializations: goku := Saiyan{ Name: "Goku", Power: 9000, } (27 shared statement(s), 7 shared atom(s))
