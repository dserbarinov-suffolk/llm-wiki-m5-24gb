---
page_id: javascriptallonge-section-const-and-lexical-scope-47dd57c2
page_kind: source
summary: const and lexical scope: 13 source-backed entries and 0 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-const-and-lexical-scope-47dd57c2@e567aded8045d8bdc3ee34f4fb4813da
---
...
- [[javascriptallonge-section-nested-blocks-3783cb0b]] - previous source section: nested blocks
- [[javascriptallonge-section-are-consts-also-from-a-shadowy-planet-7101c1ad]] - next source section: are consts also from a shadowy planet?
