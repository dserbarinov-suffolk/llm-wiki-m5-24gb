...
projection_coverage: topic-coding-little-go-book-value@9667c83393f651cf704241cd4e0c8d47
---
...
- [[coding-little-go-book-maps-array-and-slice]] - shared statements and technical atoms: Maps, Arrays and Slices shares source evidence from Chapter 3 - Maps, Arrays and Slices / Slices: Here, the output is going to be [0, 0, 0, 0, 0, 9332] . Maybe you thought it would be [9332, 0, 0, 0, 0] ? To a human, that might seem logical. To a compiler, you're ... [truncated]; Maps, Arrays and Slices shares technical record from Chapter 3 - Maps, Arrays and Slices / Slices: func main() { scores := make([]int, 0, 10) scores = scores[0:8] scores[7] = 9033 fmt.Println(scores) } (2 shared statement(s), 12 shared atom(s))
- [[coding-little-go-book-slice]] - shared statements and technical atoms: Slices shares source evidence from Chapter 3 - Maps, Arrays and Slices / Slices: Here, the output is going to be [0, 0, 0, 0, 0, 9332] . Maybe you thought it would be [9332, 0, 0, 0, 0] ? To a human, that might seem logical. To a compiler, you're ... [truncated]; Slices shares technical record from Chapter 3 - Maps, Arrays and Slices / Slices: func main() { scores := make([]int, 0, 10) scores = scores[0:8] scores[7] = 9033 fmt.Println(scores) } (2 shared statement(s), 12 shared atom(s))
- [[coding-little-go-book-maps-array]] - shared statements and technical atoms: Maps Array shares source evidence from Chapter 3 - Maps, Arrays and Slices / Slices: Finally, now that we know about slices, we can look at another commonly used built-in function: copy . copy is one of those functions that highlights how slices chan ... [truncated]; Maps Array shares technical record from Chapter 3 - Maps, Arrays and Slices / Slices: func main() { scores := make([]int, 0, 10) scores = scores[0:8] scores[7] = 9033 fmt.Println(scores) } (1 shared statement(s), 7 shared atom(s))
- [[coding-little-go-book-structure]] - shared statements and technical atoms: Structures shares source evidence from Chapter 2 - Structures / Declarations and Initializations: The answer is 9000, not 19000. Why? Because Super made changes to a copy of our original goku value and thus, changes made in Super weren't reflected in the caller. ... [truncated]; Structures shares technical record from Chapter 2 - Structures / Declarations and Initializations: goku := Saiyan{ Name: "Goku", Power: 9000, } (4 shared statement(s), 5 shared atom(s))
- [[coding-little-go-book-declaration-and-initialization]] - shared statements and technical atoms: Declarations and Initializations shares source evidence from Chapter 2 - Structures / Declarations and Initializations: The answer is 9000, not 19000. Why? Because Super made changes to a copy of our original goku value and thus, changes made in Super weren't reflected in the caller. ... [truncated]; Declarations and Initializations shares technical record from Chapter 2 - Structures / Declarations and Initializations: goku := Saiyan{ Name: "Goku", Power: 9000, } (3 shared statement(s), 5 shared atom(s))
- [[coding-little-go-book-channel]] - shared statements and technical atoms: Channels shares source evidence from Chapter 6 - Concurrency / Channels / Timeout: Also, time.After is a channel of type chan time.Time . In the above example, we simply discard the value that was sent to the channel. If you want though, you can receive it:; Channels shares technical record from Chapter 6 - Concurrency / Channels / Timeout: go func() { time.Sleep(d) c <- true }() return c } (1 shared statement(s), 3 shared atom(s))
- [[coding-little-go-book-concurrency]] - shared statements and technical atoms: Concurrency shares source evidence from Chapter 6 - Concurrency / Channels / Timeout: Also, time.After is a channel of type chan time.Time . In the above example, we simply discard the value that was sent to the channel. If you want though, you can receive it:; Concurrency shares technical record from Chapter 6 - Concurrency / Channels / Timeout: go func() { time.Sleep(d) c <- true }() return c } (1 shared statement(s), 3 shared atom(s))
- [[coding-little-go-book-timeout]] - shared statements and technical atoms: Timeout shares source evidence from Chapter 6 - Concurrency / Channels / Timeout: Also, time.After is a channel of type chan time.Time . In the above example, we simply discard the value that was sent to the channel. If you want though, you can receive it:; Timeout shares technical record from Chapter 6 - Concurrency / Channels / Timeout: go func() { time.Sleep(d) c <- true }() return c } (1 shared statement(s), 3 shared atom(s))
- [[coding-little-go-book-tidbit]] - shared statements and technical atoms: Tidbits shares source evidence from Chapter 5 - Tidbits / Initialized If: Interestingly, while the values aren't available outside the ifstatement, they are available inside any else if or else .; Tidbits shares technical record from Chapter 5 - Tidbits / Initialized If: if x := 10; count > x { ... } (2 shared statement(s), 2 shared atom(s))
