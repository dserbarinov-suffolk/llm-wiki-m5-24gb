...
projection_coverage: topic-sword-world-rpg-complete-edition-action@e4fc43c6badee542aa72b69f79dda329
---
...
- [[sword-world-rpg-complete-edition-movement]] - shared statements: Movement shares source evidence from Chapter 3: / Movement and Actions: Below are some guidelines on how movement works and which actions can be taken. For any other actions, please use common sense based on the time frame of 1 round = 1 ... [truncated] (2 shared statement(s))
