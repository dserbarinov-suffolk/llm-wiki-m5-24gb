---
page_id: javascriptallonge-const-invented
page_kind: concept
summary: why const and let were invented: 39 statement(s) and 341 atom(s) from raw/javascriptallonge.pdf.
sources: raw/javascriptallonge.pdf
updated: 2026-06-26
domain: javascriptallonge
category_path: concepts
projection_coverage: topic-javascriptallonge-const-invented@030c2dc28c6d28dda08be3e1a58ac099
---

# why const and let were invented

What [[javascriptallonge]] covers about why const and let were invented:
