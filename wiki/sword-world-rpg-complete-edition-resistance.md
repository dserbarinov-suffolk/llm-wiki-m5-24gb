...
projection_coverage: topic-sword-world-rpg-complete-edition-resistance@366e33c147046621cd38d64897c5a5bd
---
...
- [[sword-world-rpg-complete-edition-section-spellsongs-filling-out-the-character-sheet-resistance-bd12cbbd]] - source section: Spellsongs / Filling out the Character Sheet / Resistance shares source evidence from Spellsongs / Filling out the Character Sheet / Resistance: This spellsong activates the listener's physical and mental functions, giving them +1 to life force and mental power, as well as the resistance rolls of each. (5 shared statement(s))
...
- [[sword-world-rpg-complete-edition-attack-character-monster]] - shared statements and technical atoms: Attacks From Characters Against Monsters shares source evidence from 13.2.1 《 Humans 》 / 《 Life Points/Resistance 》: (Life point) resistance is a substitute for a character's life force resistance roll . When a character is poisoned, etc. a life force resistance roll determines whe ... [truncated]; Attacks From Characters Against Monsters shares technical record from 13.2.1 《 Humans 》 / 《 Life Points/Resistance 》: When a character casts a spell on a monster, they must make a success roll using their magic power as the baseline score. (3 shared statement(s), 1 shared atom(s))
- [[sword-world-rpg-complete-edition-attack-monster-character]] - shared statements and technical atoms: Attacks From Monsters Against Characters shares source evidence from 13.2.1 《 Humans 》 / 《 Life Points/Resistance 》: (Life point) resistance is a substitute for a character's life force resistance roll . When a character is poisoned, etc. a life force resistance roll determines whe ... [truncated]; Attacks From Monsters Against Characters shares technical record from 13.2.1 《 Humans 》 / 《 Life Points/Resistance 》: When a character casts a spell on a monster, they must make a success roll using their magic power as the baseline score. (3 shared statement(s), 1 shared atom(s))
