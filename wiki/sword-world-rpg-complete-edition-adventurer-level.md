...
- The patient's adventurer level and life force bonus have no influence on this check. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-05620))_
...
- A character can reduce this damage through armor (defense rolls) and adventurer level. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-05865))_
- This is exactly the same as a character's damage reduction due to armor (defense rolls) and adventurer level. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-05871))_
- Monster level, like adventurer level, prevents all damage, but a monster's defense points already include damage reduction due to monster level. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-05873))_
- Armor is ineffective against this attack, and only adventurer level can reduce the damage. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-06041))_
- Strike power is 10, bonus damage is 2, and only adventurer level can reduce it. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-06061))_
- A check for whether or not you've taken a drink is made via success roll using " adventurer level + agility bonus " as the baseline score. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-06090))_
- If your armor and adventurer level prevent you from suffering substantial damage, the needles will not pass through to your head and you will not need to make a resistance roll. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-06788))_
...
- Escaping from a giant antlion's large jaws requires a success roll using adventurer level + strength bonus as the baseline score. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-07188))_
...
- Against this acid damage, only adventurer level helps damage reduction, and armor defense power is completely ineffective. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-07405))_
- Monster level is the same as their previous adventurer level. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-07504))_
- Haunts have a minimum monster level of 5, but if they had a higher adventurer level in life, or if they died harboring a particularly strong grudge, their level will be higher. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-07581))_
- Only adventurer level and magical defense effects will work. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-07729))_
...
- Armor cannot protect against gas, only adventurer level or magical protection can reduce the damage. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08043))_
- Armor cannot protect against this fire; only adventurer level and magical defense can reduce the damage. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08198))_
- Armor cannot protect against this fire; only adventurer level and magical defense can reduce the damage. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08217))_
- Equivalents table (No Critical), then add adventurer level to the result. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08586))_
- These monsters, like adventurers, come in a variety of strengths, so it' d be more natural to describe them by their ability scores and skill levels like adventurers. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08592))_
...
- When introducing them into a scenario, assume that enemies of the same or 1 level lower than a character's adventurer level will appear frequently, while an enemy of 2-3 levels greater will appear at the climax. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08601))_
- A 3rd level dark priest is a level that would be too spicy for a novice adventurer . _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08665))_
- To escape, make a success roll using adventurer level + strength bonus as the baseline score. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08708))_
...
- Please consider the estimated reward for asking an adventurer to resolve a case to be around 50~200 times the (total of) each adventurer level. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-08822))_
...
- Monster level x 10 ÷ number of adventurers experience points will be awarded for each monster. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-09914))_
...
- An opponent who is trying to maintain the grapple may counter this by making one using adventurer level + agility bonus or adventure level + strength bonus as the baseline score, whichever is greater. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-10267))_
- To escape from a grapple, make a success roll check using adventurer level + agility bonus as the baseline score. _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-10267))_
...
**Atom:** _(Sword World RPG - Complete Edition.pdf (source-range-e5870dca-01214))_
