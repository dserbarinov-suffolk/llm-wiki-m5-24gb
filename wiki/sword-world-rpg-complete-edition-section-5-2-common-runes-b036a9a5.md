---
page_id: sword-world-rpg-complete-edition-section-5-2-common-runes-b036a9a5
page_kind: source
...
- It only appears on the market when a character discovers it, or has already discovered it, through an adventure (which means it is no longer a lost spell). _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-03898))_
- However, if magic such as Unlock , etc. _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-03900))_
...
**Context:** _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-03898))_
...
Common Runes
5.2 Common Runes
Common  runes were  invented  by Mana Rai, the great sage of Oran, and it involves  putting  the  power  of  ancient magic  into  items  (mainly  rings)  and activating it using a password in common .
...
| Theoretically, any ancient magic can be | made | into | common | runes, | but | the sorcerers' guild (academy of sages) limits what gets put on the market, to prevent the | reputation | of | magic | and | sorcerers |  |  |
| Common | runes, | like | other | magic, consume mental power when used. The amount | of | mental | power | consumed | is determined by each common rune. |  |  |  |  |
| Common | runes | can | be | used by anyone who knows the password. Also, even if you can't use your hands or are wearing metal armor, you can use them as long as you can say the word. However, no | matter | how | high | your | rune | master skill is, you cannot reduce the amount of mental | power | consumed. | When |
| Table 5-9: Common | Runes |  |  |  |  |  |  |  |  |  |  |  |  |
| Enchant Weapon | (Mental Power Consumed 3, 3000 Gamels) |  |  |  |  |  |  |  |  |  |  |  |  |
| Common | runes can be | used by |  |  |  |  |  |  |  |  |  |  |  |
| Counterspell (Mental Power Consumed | 3, 3000 Gamels) |  |  |  |  |  |  |  |  |  |  |  |  |
...
**Context:** _(Sword World RPG - Complete Edition.pdf (source-range-0d48087c-03903))_
