...
- Excerpt assembled from github.com/quii/learn-go-with-tests, covering Go language fundamentals for cross-source comparison. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00005))_
...
- The next requirement is when our function is called with an empty string it defaults to printing "Hello, World", rather than "Hello, ". _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00072))_
- Sometimes, it is useful to group tests around a "thing" and then have subtests describing different scenarios. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00075))_
...
- Sometimes, it is useful to group tests around a "thing" and then have subtests describing different scenarios. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00075))_
- A benefit of this approach is you can set up shared code that can be used in the other tests. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00076))_
- If we run our tests we should see it satisfies the new requirement and we haven't accidentally broken the other functionality. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00080))_
- It is important that your tests are clear specifications of what the code needs to do. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00081))_
...
- This will help other developers track down problems more easily. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00088))_
...
```
const englishHelloPrefix	=	"Hello,	" func Hello(name	string)	string	{ if name	==	""	{
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00078))_

```
name	=	"World" } return englishHelloPrefix	+	name }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00079))_
...
- Now that we are happy with the code, I would amend the previous commit so that we only check in the lovely version of our code with its test. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00091))_
- Now that we are happy with the code, I would amend the previous commit so that we only check in the lovely version of our code with its test. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00091))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00128))_

```
if name	==	""	{ name	=	"World" } if language	==	spanish	{ return spanishHelloPrefix	+	name } if language	==	french	{ return frenchHelloPrefix	+	name } return englishHelloPrefix	+	name }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00129))_
...
- This depends on the type, for example int s are 0 and for string s it is "" . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00142))_
- - This will display in the Go Doc for your function so it can make the intent of your code clearer. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00144))_
...
- We don't want the internals of our algorithm exposed to the world, so we made this function private. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00146))_
- For readability, it's a good idea to use a line between sets of related constants. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00147))_
- - Also, we can group constants in a block instead of declaring them on their own line. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00147))_
...
- - Write a failing test and see it fail so we know we have written a relevant test for our requirements and seen that it produces an easy to understand description of the failure _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00157))_
...
- - Then refactor, backed with the safety of our tests to ensure we have well-crafted code that is easy to work with _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00159))_
- In our case, we've gone from Hello() to Hello("name") and then to Hello("name", "French") in small, easy-to-understand steps. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00160))_
- TDD is a skill that needs practice to develop, but by breaking problems down into smaller components that you can test, you will have a much easier time writing software. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00161))_

## Integers

## You can find all the code for this chapter here

- Integers work as you would expect. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00164))_
...
- Here is a good explanation on this. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00165))_
- Note: Go source files can only have one package per directory. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00165))_

```
learnGoWithTests | |->	helloworld |				|-	hello.go |				|-	hello_test.go | |->	integers |				|-	adder_test.go | |-	go.mod |-	README.md
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00167))_
...
```
Run	the	test go	test Inspect	the	compilation	error ./adder_test.go:6:9:	undefined:	Add
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00173))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00195))_
...
- To do stuff repeatedly in Go, you'll need for . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00218))_
- Which is a good thing! _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00218))_
- In Go there are no while , do , until keywords, you can only use for . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00218))_
- In Go there are no while , do , until keywords, you can only use for . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00218))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00224))_
...
- += called "the Add AND assignment operator" , adds the right operand to the left operand and assigns the result to left operand. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00242))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00241))_
...
- - Change the test so a caller can specify how many times the character is repeated and then fix the code _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00267))_
- - Change the test so a caller can specify how many times the character is repeated and then fix the code _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00267))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00294))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00300))_
...
- They are different types so it's just the same as trying to pass a string into a function that wants an int . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00303))_
...
- The next requirement will be to sum collections of varying sizes. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00306))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00340))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00369))_
...
- We could've created a new function checkSums like we normally do, but in this case, we're showing a new technique, assigning a function to a variable. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00389))_
- It might look strange but, it's no different to assigning a variable to a string , or an int , functions in effect are values too. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00389))_
- It also allows you to reduce the surface area of your API. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00390))_
...
- Suppose that we need some geometry code to calculate the perimeter of a rectangle given a height and width. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00410))_
- We can write a Perimeter(width float64, height float64) function, where float64 is for floating-point numbers like 123.45 . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00410))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00416))_

## Write the minimal amount of code for the test to run and check the failing test output

```
Results	in shapes_test.go:10:	got	0.00	want	40.00 . func Perimeter(width	float64,	height	float64)	float64	{ return 0 }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00418))_
...
```
func TestArea(t	*testing.T)	{ t.Run("rectangles", func (t	*testing.T)	{ rectangle	:=	Rectangle{12,	6} got	:=	Area(rectangle) want	:=	72.0 if got	!=	want	{ t.Errorf("got	%g	want	%g",	got,	want) } }) t.Run("circles", func (t	*testing.T)	{ circle	:=	Circle{10} got	:=	Area(circle) want	:=	314.1592653589793
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00437))_

```
if got	!=	want	{ t.Errorf("got	%g	want	%g",	got,	want) } }) }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00438))_
...
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00439))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00441))_
...
- All we want to do is take a collection of shapes , call the Area() method on them and then check the result. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00471))_
- We want to be able to write some kind of checkArea function that we can pass both Rectangle s and Circle s to, but fail to compile if we try to pass in something that isn't a shape. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00472))_
...
- Interfaces are a very powerful concept in statically typed languages like Go because they allow you to make functions that can be used with different types and create highly-decoupled code whilst still maintaining type-safety. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00474))_
- If we try to call this with something that isn't a shape, then it will not compile. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00478))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00497))_
...
```
And	our	tests	pass! func (t	Triangle)	Area()	float64	{ return (t.Base	*	t.Height)	*	0 .5 }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00512))_
...
- It printed shapes_test.go:31: got 0.00 want 36.00 . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00526))_
- We knew this was in relation to Triangle because we were just working with it. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00527))_
- This is not a great experience for the developer, they will have to manually look through the cases to find out which case actually failed. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00527))_
- We knew this was in relation to Triangle because we were just working with it. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00527))_
- The %#v format string will print out our struct with the values in its field, so the developer can see at a glance the properties that are being tested. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00528))_
...
- To increase the readability of our test cases further, we can rename the want field into something more descriptive like hasArea . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00529))_
...
- And you can run specific tests within your table with go test -run TestArea/Rectangle . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00533))_
- And you can run specific tests within your table with go test -run TestArea/Rectangle . _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00533))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00532))_
...
- This was more TDD practice, iterating over our solutions to basic mathematic problems and learning new language features motivated by our tests. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00537))_
...
- - Table driven tests to make your assertions clearer and your test suites easier to extend & maintain _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00541))_
- This was an important chapter because we are now starting to define our own types. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00542))_
- In statically typed languages like Go, being able to design your own types is essential for building software that is easy to understand, to piece together and to test. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00542))_
- This was an important chapter because we are now starting to define our own types. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00542))_
...
```
In dictionary.go Your	test	should	now	fail dictionary_test.go:31:	should	find	added	word:	could	not	find	the word	you	were	looking	for func (d	Dictionary)	Add(word,	definition	string)	{ }
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00600))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00602))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00626))_
...
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00647))_
...
```
./dictionary_test.go:53:16:	dictionary.Update(word,	newDefinition) used	as	value ./dictionary_test.go:64:16:	dictionary.Update(word,	definition)	used as	value ./dictionary_test.go:66:23:	undefined:	ErrWordDoesNotExist
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00659))_
...
- The first argument is the map and the second is the key to be removed. _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00687))_

```
func (d	Dictionary)	Delete(word	string)	{ delete(d,	word)
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00685))_

```
}
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00686))_
...
```
./dictionary_test.go:77:10:	dictionary.Delete(word)	(no	value)	used as	value ./dictionary_test.go:90:10:	dictionary.Delete(word)	(no	value)	used as	value
```
_(source: coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00693))_
...
- Back to Testing Writing tests Go's documentation Hello, YOU A note on source control Constants Hello, world... — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00002))_
- again Back to source control Discipline Keep going! — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00002))_
- Licensed under MIT. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00005))_
- By Chris James (quii). — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00005))_
- To run it, type go run hello.go . — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00012))_
- Now create a new file called hello_test.go where we are going to write a test for our Hello function — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00022))_
- Enter go test in your terminal. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00025))_
- Enter go mod init example.com/hello in your terminal. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00027))_
- This file tells the go tools essential information about your code. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00029))_
- new folder before running commands like go test or go build . — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00030))_
- Run go test in your terminal. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00032))_
- Declaring variables We're declaring some variables with the syntax varName := value , which lets us reuse some values in our test for readability. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00033))_
- Errorf t message and fail the test. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00034))_
- We will later explore the difference between methods and functions. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00035))_
- Our next requirement is to let us specify the recipient of the greeting. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00045))_
- I wouldn't push to main though, because I plan to refactor next. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00065))_
- It's worth thinking about creating constants to capture the meaning of values and sometimes to aid performance. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00070))_
- While we have a failing test, let's fix the code, using an if . — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00077))_
- This reduces duplication and improves the readability of our tests. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00086))_
- Write a test for a user passing in Spanish. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00107))_
- Add it to the existing suite. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00107))_
- Remember not to cheat! — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00109))_
- - Write a test asserting that if you pass in "French" you get "Bonjour, — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00123))_
- - The function name starts with a lowercase letter. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00146))_
- In Go, public functions start with a capital letter, and private ones start with a lowercase letter. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00146))_
- Who knew you could get so much out of Hello, world ? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00149))_
- - if , const and switch — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00154))_
- In our case, we've gone from Hello() to Hello("name") and then to Hello("name", "French") in small, easy-to-understand steps. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00160))_
- Make sure that your files are organised into their own packages. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00165))_
- That's because we want it to print an integer rather than a string. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00170))_
- Write enough code to satisfy the compiler and that's all - remember we want to check that our tests fail for the correct reason. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00175))_
- Ah hah! Foiled again, TDD is a sham right? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00184))_
- We could write another test, with some different numbers to force that test to fail but that feels like a game of cat and mouse. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00185))_
- Often code examples that can be found outside the codebase, such as a readme file, become out of date and incorrect compared to the actual code because they don't get checked. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00198))_
- Add the following ExampleAdd function to the adder_test.go file. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00200))_
...
- Writing benchmarks in Go is another first-class feature of the language and it is very similar to writing tests. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00244))_
- You'll see the code is very similar to a test. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00246))_
- To test this it ran it 10000000 times. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00252))_
- This impacts performance, particularly during heavy string concatenation. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00256))_
- Run go test -bench=. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00260))_
- Create a new folder to work in. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00280))_
- On each iteration, range returns two values - the index and the value. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00301))_
- range lets you iterate over an array. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00301))_
- If you try to pass an [4]int into a function that expects [5]int , it won't compile. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00303))_
- We will now use the slice type which allows us to have collections of any size. The syntax is very similar to arrays, you just omit the size when declaring them — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00308))_
- - Break the existing API by changing the argument to Sum to be a slice rather than an array. When we do this, we will potentially ruin someone's day because our other test will no longer compile! — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00317))_
- In our case, no one else is using our function, so rather than having two functions to maintain, let's have just one. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00319))_
- If it works for a slice of one size it's very likely it'll work for a slice of any size (within reason). — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00328))_
- Go's built-in testing toolkit features a coverage tool. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00329))_
- Now delete one of the tests and check the coverage again. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00332))_
- Let's go ahead and put this into practice! — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00349))_
- What we need to do is iterate over the varargs, calculate the sum using our existing Sum function, then add it to the slice we will return — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00353))_
- Lots of new things to learn! — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00355))_
- We start with an empty slice sums and append to it the result of Sum as we work through the varargs. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00364))_
- If you omit the value on one of the sides of the : it captures everything to that side of it. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00374))_
- Not a lot to refactor this time. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00376))_
- What do you think would happen if you passed in an empty slice into our function? What is the "tail" of an empty slice? What happens when you tell Go to capture all elements from myEmptySlice[1:] ? — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00377))_
- Our tests have some repeated code around the assertions again, so let's extract those into a function. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00387))_
- - How to slice, slices! — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00400))_
- Check out the Go blog post on slices for an in-depth look into slices. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00405))_
- Try writing more tests to solidify what you learn from reading it. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00405))_
- So far, so easy. Now let's create a function called Area(width, height float64) which returns the area of a rectangle. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00421))_
- Now let's refactor the tests to use Rectangle instead of plain float64 s. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00431))_
- I hope you'll agree that passing a Rectangle to a function conveys our intent more clearly, but there are more benefits of using structs that we will cover later. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00434))_
- A method declaration binds an identifier, the method name, to a method, and associates the method with the receiver's base type. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00449))_
- An example will help so let's change our tests first to call methods instead and then fix the code. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00451))_
- To make circle's Area function pass we will borrow the Pi constant from the math package (remember to import it). — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00467))_
- How does something become a shape? We just tell Go what a Shape is using an interface declaration — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00479))_
- Then we fill the slice with cases. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00498))_
- Remember, keep trying to run the test and let the compiler guide you toward a solution. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00508))_
- So far you've only been shown syntax for creating instances of structs MyStruct{val1, val2} but you can optionally name the fields. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00518))_
- The test speaks to us more clearly, as if it were an assertion of truth, not a sequence of operations — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00522))_
...
- Next, let's create a function to Update the definition of a word. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00638))_
- We already know how to deal with an error like this. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00646))_
- We get 3 errors this time, but we know how to deal with these. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00660))_
- Next, let's create a function to Delete a word in the dictionary. — _unextracted: segment carries subject matter but no structured claim was recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00674))_
- It takes two arguments and returns nothing. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00687))_
- We made a full CRUD (Create, Read, Update and Delete) API for our dictionary. — _fragmentary: no subject/predicate region recovered_ _(coding_learn_go_with_tests_excerpt.pdf (source-range-559be4b1-00698))_
