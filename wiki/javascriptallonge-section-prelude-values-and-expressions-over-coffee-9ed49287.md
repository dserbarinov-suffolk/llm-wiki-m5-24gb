---
page_id: javascriptallonge-section-prelude-values-and-expressions-over-coffee-9ed49287
page_kind: source
summary: Prelude: Values and Expressions over Coffee: 1 source-backed entries and 1 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-prelude-values-and-expressions-over-coffee-9ed49287@e6bc0e1a0c779911a437e199d70c53ec
---
...
- [[javascriptallonge-section-about-the-sample-pdf-d1aca66e]] - previous source section: About The Sample PDF
- [[javascriptallonge-section-values-are-expressions-608b3ac6]] - next source section: values are expressions

## Technical atoms

### Technical frame 1: Prelude: Values and Expressions over Coffee

**Atom:** _(javascriptallonge.pdf (source-range-c98ab3e6-00097))_

<a id="atom-technical-atom-b5b1a346af97a156"></a>
```text
Prelude: Values and Expressions over Coffee
