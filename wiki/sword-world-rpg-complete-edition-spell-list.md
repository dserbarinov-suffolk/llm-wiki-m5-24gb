...
- Among the types of spells, there is one called summon . (Sword World RPG - Complete Edition.pdf p.149)
- Here is a list of dragon roar magic that dragon priests can use. (Sword World RPG - Complete Edition.pdf p.149)
- The result will determine when it will be summoned (Table 11-1: Summon). (Sword World RPG - Complete Edition.pdf p.149)
- However, the closer the target creature is , the easier it will be to summon it. (Sword World RPG - Complete Edition.pdf p.149)
...
- Therefore, it's possible to instantly summon creatures no matter where they are . (Sword World RPG - Complete Edition.pdf p.149)
