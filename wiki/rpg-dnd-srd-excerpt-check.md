...
projection_coverage: topic-rpg-dnd-srd-excerpt-check@072f8cf64ab321a3ba72a1a409cfcebd
---
...
- [[rpg-dnd-srd-excerpt-group]] - shared statements: Group shares source evidence from Ability Checks / Working Together / Group Checks: Group checks don't come up very often, and they're most useful when all the characters succeed or fail as a group. For example, when adventurers are navigating a swa ... [truncated] (1 shared statement(s))
