---
page_id: javascriptallonge-section-functions-are-not-the-real-point-ba18f1d8
page_kind: source
summary: functions are not the real point: 10 source-backed entries and 1 atom(s) from raw/javascriptallonge.pdf.
...
projection_coverage: section-javascriptallonge-section-functions-are-not-the-real-point-ba18f1d8@fbc511d563173ec1682b6ed2452849e6
---
...
- [[javascriptallonge-section-say-please-887194d6]] - previous source section: say 'please'
- [[javascriptallonge-section-a-return-to-backward-thinking-51ce8070]] - next source section: a return to backward thinking
...
### Technical frame 1: functions are not the real point
