...
- A character's six ability scores are each the totals of two of these eight subability scores. (Sword World RPG - Complete Edition.pdf p.17)
...
- 1D stands for one die , 2D stands for two dice , and 1/2D stands for half the result of one dice ( rounded up) . (Sword World RPG - Complete Edition.pdf p.17)
- In addition, a notation such as 1D+6 means to roll one dice and add 6 to the result . (Sword World RPG - Complete Edition.pdf p.17)
- Once ability scores are determined, sub-ability scores are never used during the game. (Sword World RPG - Complete Edition.pdf p.18)
...
- The average for a human is 14 in all ability scores, so other than a slightly higher life force, this character seems to be pretty average. (Sword World RPG - Complete Edition.pdf p.18)
- Once the ability scores have been determined, also find the ability bonuses and write them down on the Character Sheet. (Sword World RPG - Complete Edition.pdf p.18)
