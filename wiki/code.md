...
page_id: code
page_kind: concept
summary: Canonical concept 'Code': 2 source(s), 23 statement(s), 19 atom(s), 0 relation(s).
sources: raw/coding_learn_go_with_tests_excerpt.pdf, raw/coding_little_go_book.pdf
updated: 2026-06-26
category_path: concepts
projection_coverage: canonical-concept-code@58acf45cc8b67eaf86f8bd1cfa510855
---

# Code

Compiled concept page from 2 source(s), 23 statement(s), and 19 technical atom(s).
